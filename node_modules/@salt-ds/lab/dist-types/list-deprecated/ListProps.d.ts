...
export declare type ListSingleSelectionVariant = "default" | "deselectable";
export declare type ListMultiSelectionVariant = "multiple" | "extended";
export declare type ListSelectionVariant = ListSingleSelectionVariant | ListMultiSelectionVariant;
export declare type ListChangeHandler<Item = string, Variant extends ListSelectionVariant = "default"> = (event: SyntheticEvent, item: null | (Variant extends ListMultiSelectionVariant ? Array<Item> : Item)) => void;
export declare type ListSelectHandler<Item = string> = (event: SyntheticEvent, item: Item | null) => void;
...
export interface ListProps<Item = string, Variant extends ListSelectionVariant = "default"> extends ListBaseProps<Item> {
    disableTypeToSelect?: boolean;
    getItemIndex?: (item: Item) => number;
    highlightedIndex?: number;
    initialSelectedItem?: Variant extends ListMultiSelectionVariant ? Array<Item> : Item;

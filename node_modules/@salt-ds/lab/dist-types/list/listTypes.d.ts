...
export declare type ComponentType<T = unknown> = (props: PropsWithChildren<T>) => JSX.Element;
export declare type ListItemType<T = unknown> = ComponentType<ListItemProps<T> & {
...
export interface ListHookResult<Item, Selection extends SelectionStrategy> extends Partial<ViewportTrackingResult<Item>>, Pick<SelectionHookResult<Item, Selection>, "selected" | "setSelected">, Partial<Omit<NavigationHookResult, "listProps">> {

...
import { CollectionHookResult, CollectionItem, ListHandlers, SelectionHookResult, SelectionProps, SelectionStrategy } from "../common-hooks";
...
export interface TreeProps<T, Selection extends SelectionStrategy> extends SelectionProps<T, Selection>, Omit<HTMLAttributes<HTMLDivElement>, "onSelect"> {
    disabled?: boolean;

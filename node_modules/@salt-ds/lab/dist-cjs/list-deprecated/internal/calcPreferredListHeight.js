...
const calcPreferredListHeight = (props = {}) => {
  const {
    borderless,
  ...
  return isNaN(preferredHeight) ? void 0 : preferredHeight;
};

exports.calcPreferredListHeight = calcPreferredListHeight;
//# sourceMappingURL=calcPreferredListHeight.js.map

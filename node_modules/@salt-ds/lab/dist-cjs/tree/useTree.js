...
const useTree = ({
  ...
  const { highlightedIndex: highlightedIdx, ...keyboardHook } = useKeyboardNavigation.useKeyboardNavigation({
    containerRef,
  ...
  const treeNavigationHook = useTreeKeyboardNavigation.useKeyboardNavigation({
    collectionHook,
    highlightedIdx,
  ...
  const { isScrolling, scrollIntoView } = useViewportTracking.useViewportTracking({
    containerRef,
    contentRef,
    highlightedIdx,
    indexPositions: collectionHook.data

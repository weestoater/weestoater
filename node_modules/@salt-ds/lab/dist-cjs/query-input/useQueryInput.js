...
function useQueryInput(props, forwardedRef) {
  ...
  const queryInputBodyRef = core.useForkRef(
    forkedRef1,
    widthBodyRef
  );
  const [selectedItems, setSelectedItems] = core.useControlled({
    controlled: props.selectedItems,
    default: props.defaultSelectedItems || [],
    name: "QueryInput",
    state: "selectedItems"
  });
  const [booleanOperator, setBooleanOperator] = core.useControlled({
...
exports.useQueryInput = useQueryInput;
